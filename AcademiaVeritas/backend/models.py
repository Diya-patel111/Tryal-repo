...
class Certificate:
    ...
    Attributes:
        ...
        certificate_hash (str): SHA-256 hash for certificate data integrity verification
        blockchain_tx_hash (Optional[str]): Blockchain transaction hash for immutable storage
